...
const Wishlist = () => {
    ...
    return (
        <div>
            <div className="px-5 sm:px-0 sm:w-[561px] md:w-[761px] lg:w-[961px] xl:w-[1271px] mx-auto w-full relative flex justify-center items-center">
                <div className="flex flex-col justify-start items-start">
                    <div className="text-center w-full">
                        <h2 className="text-3xl font-extrabold text-gray-800 inline-block border-b-2 border-gray-800 pb-1">Favourites</h2>
                    </div>
                    <div className="mt-10 lg:mt-12 grid md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 lg:gap-y-0">
